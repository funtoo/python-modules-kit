...
SRC_URI="https://files.pythonhosted.org/packages/fd/9f/36197c75d9a09b1ab63f56cb985af6cd858ca3fc41fd9cd890ce69bae5b9/SecretStorage-3.1.2.tar.gz -> SecretStorage-3.1.2.tar.gz"
S="${WORKDIR}/${MY_PN}-${PV}"
