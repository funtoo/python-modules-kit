...
MY_PN="Flask"
MY_P="${MY_PN}-${PV}"
SRC_URI="https://files.pythonhosted.org/packages/69/b6/53cfa30eed5aa7343daff36622843688ba8c6fe9829bb2b92e193ab1163f/Flask-2.2.2.tar.gz -> Flask-2.2.2.tar.gz"
KEYWORDS="*"
S="${WORKDIR}/${MY_P}"
