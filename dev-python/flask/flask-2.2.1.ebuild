...
MY_PN="Flask"
MY_P="${MY_PN}-${PV}"
SRC_URI="https://files.pythonhosted.org/packages/4b/4f/50888944490f2263bd70171e8298c9626675fd3dfd750694a7beaa3484fb/Flask-2.2.1.tar.gz -> Flask-2.2.1.tar.gz"
KEYWORDS="*"
S="${WORKDIR}/${MY_P}"
