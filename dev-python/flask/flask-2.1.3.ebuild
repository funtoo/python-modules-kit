...
MY_PN="Flask"
MY_P="${MY_PN}-${PV}"
SRC_URI="https://files.pythonhosted.org/packages/5b/77/3accd62b8771954e9584beb03f080385b32ddcad30009d2a4fe4068a05d9/Flask-2.1.3.tar.gz -> Flask-2.1.3.tar.gz"
KEYWORDS="*"
S="${WORKDIR}/${MY_P}"
