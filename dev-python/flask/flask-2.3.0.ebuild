...
MY_PN="Flask"
MY_P="${MY_PN}-${PV}"
SRC_URI="https://files.pythonhosted.org/packages/04/f4/22384e109d9b7e295b20580bc6af5f45b78730d03f41f826639a5c006d1a/Flask-2.3.0.tar.gz -> Flask-2.3.0.tar.gz"
KEYWORDS="*"
S="${WORKDIR}/${MY_P}"
